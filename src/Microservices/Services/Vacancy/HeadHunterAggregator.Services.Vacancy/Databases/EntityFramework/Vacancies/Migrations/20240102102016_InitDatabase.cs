        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    accept_kids = table.Column<bool>(type: "boolean", nullable: true),
                    allow_messages = table.Column<bool>(type: "boolean", nullable: true),
                    accept_temporary = table.Column<bool>(type: "boolean", nullable: true),
                    accept_handicapped = table.Column<bool>(type: "boolean", nullable: true),
                    response_letter_required = table.Column<bool>(type: "boolean", nullable: true),
                    accept_incomplete_resumes = table.Column<bool>(type: "boolean", nullable: true),
                    head_hunter_id = table.Column<string>(type: "text", nullable: false),
                    name = table.Column<string>(type: "text", nullable: false),
                    code = table.Column<string>(type: "text", nullable: true),
                    alternate_url = table.Column<string>(type: "text", nullable: true),
                    apply_alternate_url = table.Column<string>(type: "text", nullable: true),
