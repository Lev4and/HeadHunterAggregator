namespace HeadHunter.HttpClients.HeadHunter
{
    public class HeadHunterRoutes
    {
        ...
        public const string SuggestsCompaniesQuery = "companies";

        public const string SuggestsUniversitiesQuery = "educational_institutions";

        public const string SuggestsSpecializationsQuery = "fields_of_study";

        public const string SuggestsProfessionalRolesQuery = "professional_roles";

        public const string SuggestsKeySkillsQuery = "skill_set";
